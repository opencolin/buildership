        ...
        <section className="section">
          <div className="container-page space-y-10">
            ...
            <div className="card bg-navy-700 text-white">
              ...
              <p className="mt-2 text-sm text-ink-100">Drop into the Nebius Builders Discord and post: name, skills, project idea, and what you're looking for. The Localhost for your city will route you.</p>
