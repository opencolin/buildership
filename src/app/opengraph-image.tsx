...
export const alt = "BuilderShip — Build an AI agent. 30 builders board the yacht June 14, 2026. $50K credits and a DGX Spark for the winner.";
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Build an AI agent. 30 builders. One yacht. $50K credits + DGX Spark.
          </div>
        </div>
