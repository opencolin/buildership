    ...
    body: (
      <>
        ...
        <ol>
          ...
          <li><strong>Build locally</strong> with the sponsor stack — Composio for tools, Tavily for search, Nebius Token Factory for inference, OpenClaw as the runtime — then submit your project before June 14.</li>
        </ol>
      </>
    ),
  },
