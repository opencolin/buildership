...
export const metadata: Metadata = {
  ...
  description: "Co-host BuilderShip with Composio and Nebius. 30 hand-picked builders, 10 days of daily integration time, one boat day. Internal preview.",
    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-ink-200 bg-white dark:border-ink-800 dark:bg-ink-900">
          ...
          <div className="container-page relative pt-20 pb-20 sm:pt-28 sm:pb-24 lg:pt-32">
            ...
            <p className="mt-7 max-w-2xl text-xl text-ink-600 dark:text-ink-300">
              30 hand-picked finalists. 10 days of daily integration time with your engineers. One day on a yacht in
        ...
        <Section bg="tint">
          <SectionHeader
            eyebrow="The arc"
            title="Ten days. Thirty builders. One day on the bay."
          />
