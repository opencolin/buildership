...
The Jack London Oakland experience as a hackathon. Every venue is a Jack London Square business — builders move on foot between Plank, Bicycle Coffee, the Dragon Lady dock, and Heinold's. The boat ride is the wedge: networking time on the water, sunset cruise with dinner, and a built-in cap on group size.

Working name: **Hack Jack London Square** (a.k.a. "Hack Jack").
...
|---|---|---|
| 9:00 AM | Depart on Dragon Lady | South Beach (SF) |
| 10:00 AM | Arrive — 1hr crossing | Jack London Square dock |
| 10:30 AM | Coffee tickets redeemable | Bicycle Coffee |
| 11:00 AM | Lunch + hackathon kickoff | Plank (indoor, patio, arcade rooms) |
| 3:00 PM | Coffee break — get outside | Bicycle Coffee |
...
## Plank pricing (from Angelica)

| Option | Rate | Notes |
|---|---|---|
| Both floors (full takeover) | $750/hr | |
| 1st floor only | $350/hr | |
...
- Hacking inside Plank (indoors + heated patio + arcade rooms)
- Hacking inside the Dragon Lady when docked
...
**Confirmed / in-flight:**
- [ ] Plank quote (Angelica → events@agenthack.ai)
- [ ] Harbor master — Dragon Lady dock placement (target: 50–100 yds from Plank)
- [ ] Bring own Starlink; outside cable run at Plank confirmed possible
...
- [ ] Maybe: invite Mayor of Oakland onto the boat
- [ ] Confirm Farmhouse menu / per-head pricing
...
| Who | Role | Contact |
|---|---|---|
| Captain (Dragon Lady) | Boat ops, harbor master relationship | captain@dragonladysf.com |
| Angelica | Plank events | (call in progress; event guide via email) |
| AgentHack | Event operator | events@agenthack.ai |
